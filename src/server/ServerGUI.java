 ...
 * UTA ID: 1001681737
 * Built on skeleton code from https://github.com/SrihariShastry/socketProgramming/blob/master/src/lab1/ServerGUI.java 
 */
...
public class ServerGUI implements ActionListener,WindowListener{
	...
	private void initialize() {
							...
							.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
								...
								.addGroup(groupLayout.createSequentialGroup()
									...
									.addGroup(groupLayout.createParallelGroup(Alignment.LEADING, false)
										...
										.addGroup(groupLayout.createSequentialGroup()
											.addComponent(lblClients, GroupLayout.PREFERRED_SIZE, 73, GroupLayout.PREFERRED_SIZE)
											.addGap(77)
											.addComponent(btnRefresh))
										.addComponent(scrollPane_1)))))
						.addGroup(groupLayout.createSequentialGroup()
							.addGap(135)
							.addComponent(btnStartServer, GroupLayout.PREFERRED_SIZE, 188, GroupLayout.PREFERRED_SIZE)))
		...
		groupLayout.setVerticalGroup(
			groupLayout.createParallelGroup(Alignment.TRAILING)
				.addGroup(groupLayout.createSequentialGroup()
					...
					.addComponent(lblServerLog)
					.addPreferredGap(ComponentPlacement.RELATED)
					.addComponent(scrollPane_1, GroupLayout.DEFAULT_SIZE, 221, Short.MAX_VALUE)
					.addGap(17))
		);
		...
		//http://www.java2s.com/Code/Java/SWT-JFace-Eclipse/TableExample.htm
		//Making table to track the active client list at server
	...
	// handle button clicks action on connect button
	@Override
	...
	// https://stackoverflow.com/questions/23855878/how-to-print-an-hashmap-in-swing
	// Update Active client list GUI on server using client map on server  
	...
	//Creating a Thread for Server to interact with client	
